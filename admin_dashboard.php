            ...
            <nav class="sb-sidenav accordion sb-sidenav-light shadow" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="collapse" id="colla" aria-labelledby="headingOne"
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="../231215-YSL-project/coupon-list.php">優惠券列表</a>
                                <a class="nav-link"
                                    href="../231215-YSL-project/add-coupon.php">新增優惠券</a>
                            </nav>
                        </div>
